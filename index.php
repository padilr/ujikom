...
$kondisi1 = "statuspeminjaman='belum dikembalikan'";
...
// Melakukan query untuk menghitung jumlah data di dalam tabel
$query = "SELECT COUNT(*) AS total FROM user "; // Ganti 'nama_tabel' dengan nama tabel Anda
$result = mysqli_query($conn, $query);
...
?><i class="fa-solid fa-user"></i>
                            ...
                            <div class="col-xl-4 col-md-6">
                                <div class="card bg-danger text-white mb-4">
                                    <div class="card-body">Ulasan Buku</div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                    <?php
...
// Melakukan query untuk menghitung jumlah data di dalam tabel
$query = "SELECT COUNT(*) AS total FROM ulasanbuku "; // Ganti 'nama_tabel' dengan nama tabel Anda
$result = mysqli_query($conn, $query);
...
// Melakukan query untuk menghitung jumlah data di dalam tabel
$query = "SELECT COUNT(*) AS total FROM kategoribuku "; // Ganti 'nama_tabel' dengan nama tabel Anda
$result = mysqli_query($conn, $query);
...
?><i class="fa-solid fa-list"></i>
                        ...
                        <div class="col-xl-5 col-md-6">
                            <div class="card-body">History Login</div>
