...
if (isset($_POST['submit'])) {
    ...
    if ($result) {
        header('Location: kembalikan.php'); // Redirect kembali ke halaman utama setelah berhasil mengedit data
        exit;
    } else {
...
<html lang="en">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                Halaman Mengembalikan Buku Yang di Pinjam
                            </div>
    ...
    $query = "SELECT * FROM peminjam WHERE username='$_SESSION[username]' and statuspeminjaman='belum dikembalikan'"; // Ganti 'nama_tabel' dengan nama tabel Anda
    ...
    if ($result) {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "<td><a href='baca.php?bukuID=" . $row['bukuID'] . "'>Baca Buku</a> | <a href='kembali.php?peminjamID=" . $row['peminjamID'] . "'>Kembalikan</a> ";
            echo "</tr>";
        }
    } else {
