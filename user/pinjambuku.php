...
<html lang="en">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                Halaman Daftar Buku Yang Bisa di Pinjam
                            </div>
    ...
    if ($result) {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "<td><a href='pinjam.php?bukuID=" . $row['bukuID'] . "'><i class='fa-solid fa-download'></i>Pinjam</a> | <a href='koleksi1.php?bukuID=" . $row['bukuID'] . "'><i class='fa-solid fa-star'></i>Koleksi</a> |  <a href='ulasan.php?bukuID=" . $row['bukuID'] . "'><i class='fa-solid fa-star'></i>Beri Ulasan</a></td>";
            echo "</tr>";
        }
    } else {
