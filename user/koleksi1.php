...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO koleksipribadi (judul, penulis, penerbit, tahunterbit, username) VALUES ('$judul', '$penulis', '$penerbit', '$tahunterbit', '$username')";
                        ...
                        <div class="card mb-4">
                            ...
                            <form method="POST">
                                            ...
                                            <div class="row mb-6">
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control"  type="hidden" name="penulis" value='<?php echo $data['penulis']; ?>' />
                                                        <input class="form-control"  type="hidden" name="penerbit" value='<?php echo $data['penerbit']; ?>' />
                                                        <input class="form-control"  type="hidden" name="tahunterbit" value='<?php echo $data['tahunterbit']; ?>' />
                                                        <input class="form-control"  type="hidden" name="username" value='<?=$peg['username']?>' />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="mt-4 mb-0">
                                                <div class="d-grid"><button class="btn btn-primary btn-block" name="submit">Tambahkan Ke Koleksi</button></div>
                                            </div>
                                        </form>
                            </div>
                        </div>
