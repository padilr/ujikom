                        ...
                        <div class="card mb-4">
                            ...
                            <form method="POST">
                                            <div class="row mb-3">
                                                ...
                                                <input class="form-control"  type="hidden" name="statuspeminjaman" value='belum dikembalikan'/>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating">
                                                        <input class="form-control" type="date" name="tanggalpengembalian" />
                                                        <label for="inputLastName">Tanggal Pengembalian</label>
                                                    </div>
                                                </div>
                                            </div>
                         
                                            <div class="form-floating mb-3">
                                                <input class="form-control"  type="date" name="tanggalpeminjam" />
                                                <label for="inputLastName">Tanggal Peminjaman</label>
